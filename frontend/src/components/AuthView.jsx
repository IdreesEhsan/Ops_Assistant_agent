      ...
      <div style={{
        ...
        {mode === 'registered' ? (
          ...
          <>
            ...
            <p style={{ textAlign: 'center', color: 'var(--text-muted, #94a3b8)', margin: '0 0 14px', fontSize: '13px' }}>
              {subtitle}
            </p>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  style={{ ...inputStyle, borderColor: mode === 'register' && password && !isPasswordValid ? 'rgba(248,113,113,0.6)' : mode === 'register' && password && isPasswordValid ? 'rgba(0,242,254,0.6)' : 'rgba(255,255,255,0.1)' }}
                />
              </div>
              {mode === 'register' && (
                <div style={{ marginTop: '2px', fontSize: '11px', color: password ? (isPasswordValid ? '#00f2fe' : '#f87171') : '#64748b', transition: 'color 0.2s', paddingLeft: '4px' }}>
                  {password ? (isPasswordValid ? '✓ Strong password' : 'Must be 8+ chars, a letter, a number, and a special char.') : 'Must be 8+ chars, a letter, a number, and a special char.'}
                </div>
              )}
